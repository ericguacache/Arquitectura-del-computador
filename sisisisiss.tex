...
\usepackage{xltabular}  % Combina tablas de ancho fijo con multipágina
...
\begin{document}
	...
	% TABLA ÚNICA MULTIPÁGINA CON LÍNEAS INTERMEDIAS (Mantiene el estilo original de booktabs)
	\small
	\begin{xltabular}{\textwidth}{>{\raggedright\arraybackslash}p{2.2cm} | >{\raggedright\arraybackslash}p{2.2cm} | >{\raggedright\arraybackslash}p{3cm} | >{\raggedright\arraybackslash}p{3.5cm} X}
		...
		\midrule % Línea completa para separar grandes categorías
