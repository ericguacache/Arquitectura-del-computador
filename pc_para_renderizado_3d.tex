...
% Title
\title{\textbf{Informe desenfadado: PC para Renderizado 3D\\ por menos de 3000 dólares}}
\author{yo}
\date{no se wey}
...
\begin{document}
	...
	\section{¿Para qué necesitamos esta bestia?}
	...
	El presupuesto es de \textbf{3000 dólares} como máximo. Con esa cifra podemos montar una máquina increíble, equilibrada y fiable. Hemos elegido componentes de marcas reconocidas, sin experimentos raros, priorizando la potencia bruta pero sin olvidar la estabilidad térmica y eléctrica. ¿Lo mejor? Nos sobrarán casi 340\$ para caprichos, almacenamiento extra o licencias de software.
	
	En este informe te contamos qué hemos escogido, por qué y qué rendimiento puedes esperar. Y lo haremos en un tono relajado, porque ya está bien de informes aburridos. ¡Vamos al lío!
	
	\section{Lista de componentes y precios}
	Aquí tienes el resumen de lo que montaremos. Todos los precios son estimados en USD a fecha de mayo de 2026 y pueden variar según la tienda. Para que no pierdas tiempo, los enlaces en el modelo te llevan directamente al producto en Amazon.
	...
	\begin{table}[H] 
		...
		\begin{tabular}{@{}ll p{5.5cm} l@{}}
			...
			\midrule
			GPU & \href{https://www.amazon.es/Tarjeta-GIGABYTE-WINDFORCE-enfriamiento-GV-N5080WF3OC-16GD/dp/B0DS2R7N4F}{RTX 5080 WINDFORCE OC} & 16 GB GDDR7, 10752 CUDA, PCIe 5.0 & \$1,100.00 \\
			\midrule
			RAM & \href{https://www.amazon.com/-/es/CORSAIR-Vengeance-Memoria-computadora-compatible/dp/B0CJ8ZHMVF}{Corsair Vengeance DDR5} & 32 GB (2×16), 6000 MT/s, CL30, EXPO & \$149.99 \\
			\midrule
			Placa base & \href{https://www.amazon.es/MSI-MAG-TOMAHAWK/dp/B0DGB8Q19Y}{MSI X870 TOMAHAWK WIFI} & Chipset X870, AM5, PCIe 5.0, Wi‑Fi 7 & \$314.40 \\
			\midrule
			Refrigeración & \href{https://www.amazon.es/Noctua-NH-D15-chromax-Black-Enfriador-torres/dp/B07Y87YHRH}{Noctua NH-D15 chromax.black} & Doble torre, 6 heatpipes, 2 vent. 140 mm & \$179.95 \\
			\midrule
			Fuente & \href{https://www.amazon.com/-/es/MSI-alimentaci%C3%B3n-compacta-totalmente-garant%C3%ADa/dp/B0CT3XNCZ9}{MSI MAG A1000GL PCIE5} & 1000 W, 80+ Gold, ATX 3.1, modular & \$169.99 \\
			\midrule
			Almac. & \href{https://www.amazon.com/-/es/Crucial-computadoras-port%C3%A1tiles-escritorio-recuperaci%C3%B3n/dp/B0DC8VPSHV}{Crucial P310 NVMe M.2} & 1 TB, PCIe Gen4, lectura 7.100 MB/s & \$144.00 \\
			\midrule
			Pasta térmica & Thermal Grizzly Kryonaut & 12.5 W/mK, no conductora (1 g) & \$14.00 \\
			\midrule
			Chasis & \href{https://www.amazon.com/-/es/computadora-estante-disipaci%C3%B3n-ampliamente-extendido/dp/B0DDXBRJZ3}{Estante abierto (open frame)} & Estructura ATX, montaje vertical & \$90.00 \\
			\midrule
			\multicolumn{3}{r}{\textbf{Total estimado}} & \textbf{\$2,661.33} \\
			\bottomrule
		\end{tabular}
	...
	Aquí te explicamos la selección sin tecnicismos innecesarios. Cada componente suma para que el conjunto sea una máquina estable, rápida y lista para tragarse renders como pipas.
	
	\subsection{CPU: AMD Ryzen 9 9950X}
	Este procesador es el rey del renderizado por CPU. Con 16 núcleos y 32 hilos, maneja simulaciones y cálculos de iluminación como si nada. Su frecuencia turbo de hasta 5.7 GHz también acelera el modelado y la animación, que dependen más de un solo núcleo. 
