...
\usepackage{float}     % ¡NUEVO! Para fijar la posición de las tablas con [H]
...
\begin{document}
	...
	\begin{table}[H] % Cambiado a [H] para fijar posición
		\centering
	...
	% PARTE 1 DE LA TABLA: Aritmética y Transferencia
	\begin{table}[H] 
		\centering
		\small
		\begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}p{2.2cm} >{\raggedright\arraybackslash}p{2.2cm} >{\raggedright\arraybackslash}p{3cm} >{\raggedright\arraybackslash}p{3.5cm} X}
			\toprule
	...
	% PARTE 2 DE LA TABLA: Lógica y Saltos (Pasará limpiamente a la siguiente página)
	\begin{table}[H]
		\centering
		\small
		\begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}p{2.2cm} >{\raggedright\arraybackslash}p{2.2cm} >{\raggedright\arraybackslash}p{3cm} >{\raggedright\arraybackslash}p{3.5cm} X}
